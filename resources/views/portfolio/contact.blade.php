    ...
    <div class="container">
        <div class="flex flex-wrap">
            <div class="w-full px-4 lg:w-1/2">
                <form action="{{ route('contact.store') }}" method="POST" class="font-nunito lg:w-10/12">
                    @csrf
                    <div class="w-full md:mx-auto">
                        ...
                        <div class="w-full px-4">
                            <button type="submit" class="px-4 py-2 w-full bg-primary border-primary text-white rounded-lg text-sm lg:text-base hover:bg-secondary transition-all duration-200 ease-in-out active:scale-95">Send</button>
                        </div>
                    </div>
                </form>
            </div>
